...
Authzee is a highly expressive grant-based authorization Engine that is 

This is the official python SDK for Authzee and it is async, extensible, and scalable. 
